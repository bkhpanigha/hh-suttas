...
import fetchSuttaData from './js/database/fetchSuttaData.js';
import getDocumentAreas from './js/utils/getDocumentAreas.js';
import { getSuttasByIds } from './js/utils/getSuttasByIds.js';
import { goBack } from './js/utils/navigation/goBack.js';
import { showForeword } from './js/utils/userActions/showForeword.js';
import { scrollToHash } from './js/utils/navigation/scrollToHash.js';


const {suttaArea, whatsNewArea, homeButton, themeButton, bodyTag, previous, next} 
  = getDocumentAreas();
